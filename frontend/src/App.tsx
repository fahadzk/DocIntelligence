...
function ProjectWorkspace({ project, onEdit }: { project: Project; onEdit: () => void }) { return <section><PageHeader eyebrow="Project workspace" title={project.name} actions={<IconButton aria-label="Edit project" title="Edit project" onClick={onEdit}>•••</IconButton>} /><DocumentsWorkspace key={project.id} project={project} /><div className="future-features"><span>Search <Badge>Coming later</Badge></span><span>Ask <Badge>Coming later</Badge></span></div></section>; }
